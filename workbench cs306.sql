...
insert into Airlines( a_id, a_name, co2_emission, establishment_date, founder)
...
insert into Plane_Type(t_id,capacity,model_name,fuel_usage,manufacturer)
...
insert into Planes(p_id, manifacture_date,type_id, airline_id)
...
CREATE TABLE Business (
    seat_number VARCHAR(10),
    f_id INT,
    extra_leg_room TINYINT(1),
    complimentary_meals TINYINT(1),
    PRIMARY KEY (seat_number, f_id),
...
INSERT INTO Seats (seat_number, f_id, is_booked, price, near_emergency_exit)
VALUES 
...
INSERT INTO Staff (s_id, name, job, salary, experience)
VALUES 
...
INSERT INTO Economy (seat_number, f_id)
VALUES 
    ('12A', 2),  
    ('12B', 2),  
    ('12C', 2), 
    ...
    ('14A', 4), 
    ('15A', 5); 
INSERT INTO Business (seat_number, f_id, advantages)
VALUES 
    ('1A', 1, 'Lounge access' ),
    ('1B', 1, 'Priority boarding');            
    
INSERT INTO Flights (f_id, flight_date, gate_no, departure_airport, arrival_airport, duration, p_id)
VALUES 
...
INSERT INTO Internationalflights (f_id, departure_country, arrival_country)
VALUES
...
INSERT INTO Domesticflights (f_id, departure_city, arrival_city)
VALUES
